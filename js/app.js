  ...
  setup(context) {
    ...
    watch(angle, (value) => {
      if (
        ...
        // 超級簡單
        (difficulty.value === 2 && (value >  || value < -))
      ) {
        game.value = 2
      }
    })
